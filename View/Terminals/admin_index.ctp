<div class="questions index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php //echo $this->Html->link(__('Answer'), array('admin'=>false,'controller'=>'answers','action' => 'add', $terminal['Terminal']['id'])); ?>
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('New Question'), array('action' => 'add','controller'=>'questions')); ?></li>
